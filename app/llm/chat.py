...
def main():
    ...
    formatted_contents = ContentsFormatter(user_prompt=user_prompt,
                                                chat_logs=[],
    ...
    gemini_config = Config(system_instruction=gemini_system_instruction.system_prompt, response_schema=gemini_response)
    gemini_client = GeminiClient(config=gemini_config.setup_config, contents=formatted_contents.formatted_contents)
